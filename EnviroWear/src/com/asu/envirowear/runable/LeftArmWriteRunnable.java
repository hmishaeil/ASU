...
public class LeftArmWriteRunnable implements Runnable {
	...
	public LeftArmWriteRunnable(Object lockObject, TemperatureInput temperatureInput,
	...
	public void run() {
		while (!Thread.currentThread().isInterrupted()) {
			...
			synchronized (this.lockObject) {
				temperatureThreshold.setCurrentTemperature(this.temperatureInput.getLeftArmTemperatureInput());
